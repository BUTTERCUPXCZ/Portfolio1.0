  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <ParallaxElement speed={0.1} disabled={reducedMotion}>
        <motion.div
          className="absolute top-1/4 left-1/4 w-48 h-48 bg-blue-500/5 rounded-full blur-xl opacity-30"
          animate={{
            x: [0, 25, 0],
            y: [0, -15, 0],
          }}
      ...
      <ParallaxElement speed={0.15} disabled={reducedMotion}>
        <motion.div
          className="absolute top-3/4 right-1/4 w-64 h-64 bg-purple-500/5 rounded-full blur-xl opacity-30"
          animate={{
            x: [0, -35, 0],
            y: [0, 20, 0],
          }}
