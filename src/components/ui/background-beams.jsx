    ...
    >
      ...
      >
        ...
        {paths.map((path, index) => {
          // Only animate every 4th path to improve performance
        ...
        <defs>
          {paths.map((path, index) => {
            // Only create gradients for animated paths
            if (index % 4 !== 0) return null;
          ...
          >
            <stop offset="0.0666667" stopColor="#71717a" />
            <stop offset="0.243243" stopColor="#71717a" />
