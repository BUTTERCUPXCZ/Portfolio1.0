  ...
  return (
    <div className='max-w-[1200px] mx-auto flex justify-between p-6 md:p-20 text-sm md:text-lg mt-12 border-t border-gray-800/50'>
      <div className='space-y-4'>
         <h3 className='text-2xl text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 font-semibold'>Ivan Eltagonde</h3>
         <div className='flex flex-row gap-6 text-gray-400 text-4xl'>
           ...
           <a href="https://www.instagram.com/ivan.eltagonde/" className="hover:text-pink-400 transition-colors duration-300"><FaInstagram /></a>
         </div>
      </div>
