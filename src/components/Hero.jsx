          ...
          >
            ...
            >
             ...
             <div className='flex gap-6 flex-row text-4xl md:text-5xl text-blue-400 z-20'>
                <motion.a whileHover={{scale: 1.1 }} href='https://github.com/BUTTERCUPXCZ'>
                    <AiOutlineGithub/>
                </motion.a>
                <motion.a whileHover={{scale: 1.1 }} href='https://www.linkedin.com/in/ivan-eltagonde-38a853312/'>
                    <AiOutlineLinkedin/>
                </motion.a>
                <motion.a whileHover={{scale: 1.1 }} href='https://www.instagram.com/ivan.eltagonde/'>
                    <AiOutlineInstagram/>
                </motion.a>
           ...
           <motion.div
                ...
                <div className="absolute inset-0 flex items-center justify-center z-0 pointer-events-none">
                  <div className="w-[320px] md:w-[400px] h-[320px] md:h-[400px] rounded-full blur-2xl bg-blue-500/20 opacity-60"></div>
                  <div className="w-[260px] md:w-[320px] h-[260px] md:h-[320px] rounded-full blur-xl bg-blue-400/30 opacity-40"></div>
                </div>
