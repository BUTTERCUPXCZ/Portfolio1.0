...
import { SiExpress, SiFigma, SiGithub, SiPrisma, SiReact } from 'react-icons/si';
...
const skills = [
  {
    ...
    technologies: [
      ...
      { name: 'TanStack', icon: <SiReact className="text-teal-400" /> },
      { name: 'Shadcn UI', icon: <FaLayerGroup className="text-gray-300" /> },
    ],
  },
  {
    category: 'Backend',
    technologies: [
      ...
      { name: 'Postgres', icon: <DiPostgresql className="text-blue-700 " /> },
  ...
  },
  {
    ...
    technologies: [
      ...
      { name: 'Git', icon: <SiGithub className="text-orange-500" /> },
